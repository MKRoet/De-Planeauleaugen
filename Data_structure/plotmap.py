...
# the objectclasses.py and a PlotMap function that plot the floor plan with use of
# matplotlib.
#-------------------------------------------------------------------------------
...
def PlotMap(objects, title):
    ...
    # Iterates over all houses and water in the objectList and creates a patch for
    # every house/water in list. Uses Rectangle-patch to create house and distance
    # with round corners on map.
